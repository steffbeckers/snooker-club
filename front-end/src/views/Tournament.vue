          ...
          <v-card-text>
            <v-container>
              <v-row>
                <v-col cols="3">
                  <v-dialog
                    ref="showAddFrameDialogStartDatePickerRef"
                    v-model="showAddFrameDialogStartDatePicker"
                    :return-value.sync="addFrameStartDate"
                    persistent
                    width="290px"
                  >
                    <template v-slot:activator="{ on }">
                      <v-text-field
                        v-model="addFrameStartDate"
                        label="Startdatum"
                        prepend-icon="event"
                        readonly
                        v-on="on"
                    ...
                    >
                      ...
                      <v-btn
                        text
                        @click="
                          showAddFrameDialogStartDatePicker = false
                        "
                        >Sluiten</v-btn
                      >
                      <v-btn
                        text
                        color="primary"
                        @click="$refs.showAddFrameDialogStartDatePickerRef.save(addFrameStartDate)"
                        >OK</v-btn
                      >
                    </v-date-picker>
                  </v-dialog>
                ...
                <v-col cols="3">
                  <v-dialog
                    ref="showAddFrameDialogStartTimePickerRef"
                    v-model="showAddFrameDialogStartTimePicker"
                    :return-value.sync="addFrameStartTime"
                    persistent
                    width="290px"
                  >
                    <template v-slot:activator="{ on }">
                      <v-text-field
                        v-model="addFrameStartTime"
                        label="Starttijd"
                    ...
                    <v-time-picker
                      v-if="showAddFrameDialogStartTimePicker"
                      v-model="addFrameStartTime"
                      full-width
                      :format="timePickerFormat"
                    >
                      <v-spacer></v-spacer>
                      <v-btn text @click="showAddFrameDialogStartTimePicker = false">Sluiten</v-btn>
                      <v-btn text color="primary" @click="$refs.showAddFrameDialogStartTimePickerRef.save(addFrameStartTime)">OK</v-btn>
                    </v-time-picker>
                  </v-dialog>
                </v-col>
                <v-col cols="3">
                  <v-dialog
                    ref="showAddFrameDialogEndDatePickerRef"
                    v-model="showAddFrameDialogEndDatePicker"
                    :return-value.sync="addFrameEndDate"
                    persistent
                    width="290px"
                  >
                    <template v-slot:activator="{ on }">
                      <v-text-field
                        v-model="addFrameEndDate"
                        label="Einddatum"
                        prepend-icon="event"
                        readonly
                        v-on="on"
                    ...
                    >
                      ...
                      <v-btn
                        text
                        @click="
                          showAddFrameDialogEndDatePicker = false
                        "
                        >Sluiten</v-btn
                      >
                      <v-btn
                        text
                        color="primary"
                        @click="$refs.showAddFrameDialogEndDatePickerRef.save(addFrameEndDate)"
                        >OK</v-btn
                      >
                    </v-date-picker>
                  </v-dialog>
                ...
                <v-col cols="3">
                  <v-dialog
                    ref="showAddFrameDialogEndTimePickerRef"
                    v-model="showAddFrameDialogEndTimePicker"
                    :return-value.sync="addFrameEndTime"
                    persistent
                    width="290px"
                  >
                    <template v-slot:activator="{ on }">
                      <v-text-field
                        v-model="addFrameEndTime"
                        label="Eindtijd"
                        prepend-icon="access_time"
                        readonly
                        v-on="on"
                    ...
                    <v-time-picker
                      v-if="showAddFrameDialogEndTimePicker"
                      v-model="addFrameEndTime"
                      full-width
                      :format="timePickerFormat"
                    >
                      <v-spacer></v-spacer>
                      <v-btn text @click="showAddFrameDialogEndTimePicker = false">Sluiten</v-btn>
                      <v-btn text color="primary" @click="$refs.showAddFrameDialogEndTimePickerRef.save(addFrameEndTime)">OK</v-btn>
                    </v-time-picker>
                  </v-dialog>
                </v-col>
              </v-row>
      ...
      <v-layout wrap>
        <v-flex xs12 sm8 v-if="tournament.players.length >= 3">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(4), playerOnPosition(6))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                    ...
                    <tr>
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(5), playerOnPosition(6))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                    ...
                    <tr>
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(6), playerOnPosition(4))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(6), playerOnPosition(5))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                      ...
                      <td class="text-center total-score">
                        <span class="title">{{
                          playerTotalFramesInPhase(playerOnPosition(6), 1)
                        }}</span>
                      </td>
                    </tr>
                  </tbody>
          ...
          <v-card v-if="tournament.players.length === 4" class="ma-2 mb-4">
            <v-card-title class="pb-0">
              <span>Poule 1</span>
              <span class="ml-4 grey-text body-1 font-weight-light">Best of 3</span>
            </v-card-title>
            <v-card-text>
                ...
                <template v-slot:default>
                  <thead>
                    <tr>
                      ...
                      <th class="text-center pl-0 pr-0">2</th>
                      <th class="text-center pl-0 pr-0">3</th>
                      <th class="text-center pl-0 pr-0">4</th>
                      <th class="text-center pl-0 pr-0">5</th>
          ...
          <!-- 5 -->
          <!-- 7, 8 -->
          <v-card v-if="tournament.players.length === 7 || tournament.players.length === 8" class="ma-2 mb-4">
            <v-card-title>
              <span>Poule 1</span>
          ...
          <v-card v-if="tournament.players.length === 7 || tournament.players.length === 8" class="ma-2 mb-4">
            <v-card-title>
              <span>Poule 2</span>
              <span class="ml-4 grey-text body-1 font-weight-light">
                <span v-if="tournament.players.length === 7">2 frames</span>
                <span v-if="tournament.players.length === 8">1 frame</span>
              </span>
            </v-card-title>
            <v-card-text>
              <v-simple-table class="tournament">
                <template v-slot:default>
                  <thead>
                    <tr>
                      ...
                      <th class="text-center pl-0 pr-0">2</th>
                      <th class="text-center pl-0 pr-0">3</th>
                      <th v-if="tournament.players.length === 8" class="text-center pl-0 pr-0">4</th>
                      <th class="text-center">Totaal</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(5), playerOnPosition(7))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                      ...
                      <td
                        v-if="tournament.players.length === 8"
                        class="text-center"
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(5), playerOnPosition(8))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                    ...
                    <tr>
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(6), playerOnPosition(7))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(6), playerOnPosition(8))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                    ...
                    <tr>
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(7), playerOnPosition(5))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(7), playerOnPosition(6))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                    ...
                    <tr v-if="tournament.players.length === 8">
                      <td>
                        <v-autocomplete
                          :items="tournament.players"
                          placeholder="Selecteer speler"
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(8), playerOnPosition(5))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
                      ...
                      <td
                        ...
                        style="cursor: pointer"
                        @click="
                          showAddFrame(playerOnPosition(8), playerOnPosition(6))
                        "
                      >
                        <span class="title">{{
                          playerFramesWonAgainstInPhase(
          ...
          >
            ...
            <v-card-text>
                  ...
                  <v-layout colunm>
                    <v-flex xs12>
                      <v-layout row>
                        ...
                        <v-flex
                          :class="{ 'pt-2': !playerOnPosition(20001) || !playerOnPosition(20002) }"
                          xs4
                        >
                          <v-container class="pa-0">
                            <v-row align="start" justify="center">
                              <div>
                                <span class="mr-1">Frames</span>
                                <v-btn
                                  v-if="playerOnPosition(20001) && playerOnPosition(20002)"
                                  @click="showAddFrame(playerOnPosition(20001), playerOnPosition(20002), 20000)" icon>
                                  <v-icon>mdi-plus-circle</v-icon>
                                </v-btn>
                              </div>
                            </v-row>
              ...
              <div class="tournament tournament__bracket mt-4">
                <v-container class="pt-0">
                  <v-layout colunm>
                    <v-flex xs12>
                      <v-layout row>
                        ...
                        <v-flex 
                          :class="{ 'pt-2': !playerOnPosition(20003) || !playerOnPosition(20004) }"
                          xs4
                        >
                          <v-container class="pa-0">
                            <v-row align="start" justify="center">
                              <div>
                                <span class="mr-1">Frames</span>
                                <v-btn 
                                  v-if="playerOnPosition(20003) && playerOnPosition(20004)"
                                  @click="showAddFrame(playerOnPosition(20003), playerOnPosition(20004), 20000)" icon>
                                  <v-icon>mdi-plus-circle</v-icon>
                                </v-btn>
                              </div>
                            </v-row>
                        ...
                        <v-flex xs4>
                          ...
                          <v-autocomplete
                            ...
                            solo
                            flat
                            :value="playerOnPosition(20004)"
                            @change="upsertPlayerPositionTournament($event, 20004)"
                            @click:clear="deletePlayerPositionTournament(20004)"
                          >
                            <template v-slot:selection="data">
                              {{ data.item.firstName }} {{ data.item.lastName }}
                            </template>
          ...
          <v-card class="ma-2">
            <v-card-title>
              <span>Finale</span>
              <span class="ml-4 grey-text body-1 font-weight-light">Voor 22:15 best of 3</span>
            </v-card-title>
            <v-card-text>
              <div class="tournament tournament__bracket">
                <v-container class="pt-0">
                      ...
                      <v-layout row>
                        <v-flex xs4>
                          ...
                          <v-autocomplete
                            ...
                            solo
                            flat
                            :value="playerOnPosition(10001)"
                            @change="upsertPlayerPositionTournament($event, 10001)"
                            @click:clear="deletePlayerPositionTournament(10001)"
                          >
                            <template v-slot:selection="data">
                              {{ data.item.firstName }} {{ data.item.lastName }}
                            </template>
                        ...
                        <v-flex
                          xs4
                          :class="{ 'pt-2': !playerOnPosition(10001) || !playerOnPosition(10002) }"
                        >
                          <v-container class="pa-0">
                            <v-row align="start" justify="center">
                              <div>
                                ...
                                <v-btn 
                                  v-if="playerOnPosition(10001) && playerOnPosition(10002)"
                                  @click="showAddFrame(playerOnPosition(10001), playerOnPosition(10002), 10000)"
                                  icon
                                >
                                  <v-icon>mdi-plus-circle</v-icon>
                                </v-btn>
                            ...
                            <v-row align="start" justify="center" class="display-1">
                              <v-col cols="4" class="pa-0 text-right">
                                {{
                                  playerFramesWonAgainstInPhase(
                                    playerOnPosition(10001),
                                    playerOnPosition(10002),
                                    10000
                                  )
                                }}
                              </v-col>
                        ...
                        <v-flex xs4>
                          ...
                          <v-autocomplete
                            ...
                            solo
                            flat
                            :value="playerOnPosition(10002)"
                            @change="upsertPlayerPositionTournament($event, 10002)"
                            @click:clear="deletePlayerPositionTournament(10002)"
                          >
                            <template v-slot:selection="data">
                              {{ data.item.firstName }} {{ data.item.lastName }}
                            </template>
        ...
        <v-flex xs12 sm4>
          ...
          >
            <v-card-title>
              <span>Spelers</span>
              <span v-if="tournament.players.length >= 3">&nbsp;({{ tournament.players.length }})</span>
              <v-spacer></v-spacer>
              <v-dialog
                ...
                <v-card>
                      ...
                      <v-row>
                        <v-col cols="12">
                          <v-autocomplete
                            ...
                            clearable
                            return-object
                            @change="upsertPlayerTournament(newPlayer)"
                          >
                            <template v-slot:selection="data">
                              {{ data.item.firstName }} {{ data.item.lastName }}
                            </template>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn
                      ...
                      >Sluiten</v-btn
                    >
                    <!-- For now automatically adding the player on change/select -->
                    <!-- <v-btn
                      color="blue darken-1"
                      text
...
export default {
  ...
  data: () => ({
    ...
    showAddFrameDialogStartDatePicker: false,
    addFrameStartDate: moment().subtract(20, "minutes").format("YYYY-MM-DD"),
    showAddFrameDialogStartTimePicker: false,
    addFrameStartTime: moment().subtract(20, "minutes").format("HH:mm"),
    showAddFrameDialogEndDatePicker: false,
    addFrameEndDate: moment().format("YYYY-MM-DD"),
    showAddFrameDialogEndTimePicker: false,
    addFrameEndTime: moment().format("HH:mm"),
  ...
  methods: {
    ...
    showAddFrame(player1, player2, phase = 1) {
      ...
      // When opening the dialog => reset dates
      // TODO: Instead of moment() => use date of tournament?
      this.showAddFrameDialogStartDatePicker = false;
      this.addFrameStartDate = moment().subtract(20, "minutes").format("YYYY-MM-DD");
      this.showAddFrameDialogStartTimePicker = false;
      this.addFrameStartTime = moment().subtract(20, "minutes").format("HH:mm");
      this.showAddFrameDialogEndDatePicker = false;
      this.addFrameEndDate = moment().format("YYYY-MM-DD");
      this.showAddFrameDialogEndTimePicker = false;
      this.addFrameEndTime = moment().format("HH:mm");
    ...
    addFrame() {
      ...
      const frame = {
        ...
        startDate: this.addFrameStartDate && this.addFrameStartTime ? this.addFrameStartDate + "T" + this.addFrameStartTime + ":00" : moment().subtract(20, "minutes").toISOString(),
        endDate: this.addFrameEndDate && this.addFrameEndTime ? this.addFrameEndDate + "T" + this.addFrameEndTime + ":00" : moment().toISOString(),
        winnerId:
