<template>
  <div v-if="league" class="league-view">
    <v-toolbar class="elevation-0">
      ...
      <v-spacer></v-spacer>
      <v-toolbar-items>
        <v-btn @click="showAddTournamentDialog = true" text>Toernooi toevoegen</v-btn>
      </v-toolbar-items>
    </v-toolbar>
        ...
        <v-flex v-if="league.tournaments" xs12 sm8 class="league__tournaments">
          <v-card class="ma-2">
            <v-card-title>
              ...
              <v-spacer></v-spacer>
              <v-dialog v-model="showAddTournamentDialog" persistent max-width="600px">
                ...
                <v-card>
                  <v-card-title>
                    <span class="headline">Toernooi toevoegen aan {{ league.displayName }}</span>
                  </v-card-title>
                  <v-card-text>
                    <v-container>
                      <v-row>
                        <v-col cols="12">
                          ...
                          >
                            ...
                            >
                              <v-spacer></v-spacer>
                              <v-btn text color="primary" @click="showAddTournamentDialogDatePicker = false">Cancel</v-btn>
                              <v-btn text color="primary" @click="$refs.dialog.save(newTournament.date)">OK</v-btn>
                            </v-date-picker>
                          </v-dialog>
                        </v-col>
                      </v-row>
                  ...
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="darken-1" text @click="showAddTournamentDialog = false">Sluiten</v-btn>
                    <v-btn color="blue darken-1" text @click="addTournament()">Toevoegen</v-btn>
                  </v-card-actions>
                </v-card>
              </v-dialog>
            </v-card-title>
          ...
          <v-card class="ma-2">
            <v-card-title>
              ...
              <v-dialog v-model="showAddPlayerDialog" persistent max-width="500px">
                ...
                <v-card>
                  <v-card-title>
                    <span class="headline">Speler toevoegen aan {{ league.displayName }}</span>
                  </v-card-title>
                  <v-card-text>
                    <v-container>
                      <v-row>
